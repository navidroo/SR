...
parser.add_argument('--pre-patience', type=int, default=5, help='Patience for early stopping in pre-iterations')
parser.add_argument('--train-patience', type=int, default=3, help='Patience for early stopping in training iterations')
parser.add_argument('--min-delta', type=float, default=1e-4, help='Minimum change in loss for early stopping')
